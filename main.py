...
class Config:
    ...
    def from_env(cls) -> "Config":
        ...
        return cls(
            ...
            min_score=int(os.environ.get("MIN_ALERT_SCORE", "70")),
        )
...
Return null if the filing is routine, low impact, from a tiny/SME/penny/suspended company, or below score 70.
...
def check_announcements() -> None:
    ...
    for ann in announcements[:25]:
        ...
        ann_id = f"{symbol}|{subject}|{ann_time}|{pdf_path}"
        ...
        pdf_text = nse.pdf_text(pdf_path) if pdf_path else ""
