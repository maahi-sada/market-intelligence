...
FNO_SYMBOLS = [
    "ABB", "ABCAPITAL", "ABFRL", "ACC", "ADANIENT",
"ADANIGREEN", "ADANIPORTS", "ADANIPOWER", "ALKEM",
"AMBUJACEM", "ANGELONE", "APLAPOLLO", "APOLLOHOSP",
"ASHOKLEY", "ASIANPAINT", "ASTRAL", "ATGL",
"AUBANK", "AUROPHARMA", "AXISBANK",

"BAJAJ-AUTO", "BAJAJFINSV", "BAJFINANCE", "BALKRISIND",
"BANDHANBNK", "BANKBARODA", "BEL", "BERGEPAINT",
"BHARATFORG", "BHARTIARTL", "BHEL", "BIOCON",
"BPCL", "BRITANNIA",

"CAMS", "CANBK", "CDSL", "CGPOWER", "CHAMBLFERT",
"CHOLAFIN", "CIPLA", "COALINDIA", "COCHINSHIP",
"COFORGE", "COLPAL", "CONCOR", "CROMPTON",

"DABUR", "DALBHARAT", "DEEPAKNTR", "DELHIVERY",
"DIVISLAB", "DIXON", "DLF", "DRREDDY",
...
"GODREJPROP", "GRANULES", "GRASIM",

"HAL", "HAVELLS", "HCLTECH", "HDFCAMC", "HDFCBANK",
"HDFCLIFE", "HEROMOTOCO", "HINDALCO", "HINDCOPPER",
"HINDPETRO", "HINDUNILVR", "HUDCO", "HYUNDAI",

"ICICIBANK", "ICICIGI", "ICICIPRULI", "IDEA",
"IDFCFIRSTB", "IEX", "IGL", "INDHOTEL",
"INDIAMART", "INDIGO", "INDUSINDBK", "INDUSTOWER",
"INFY", "IOC", "IRB", "IRCTC", "IREDA",
"IRFC", "ITC",

"JINDALSTEL", "JIOFIN", "JSWENERGY", "JSWSTEEL",

"KALYANKJIL", "KEI", "KOTAKBANK",

"LICHSGFIN", "LICI", "LODHA", "LT", "LTIM",
"LTTS", "LUPIN",

"M&M", "MANAPPURAM", "MARICO", "MARUTI",
"MAXHEALTH", "MCX", "METROPOLIS", "MFSL",
"MGL", "MOTHERSON", "MOTILALOFS", "MPHASIS",
"MRF", "MUTHOOTFIN",

"NAM-INDIA", "NATIONALUM", "NAUKRI", "NAVINFLUOR",
"NESTLEIND", "NHPC", "NMDC", "NTPC", "NYKAA",

"OBEROIRLTY", "OFSS", "OIL", "ONGC",

"PAGEIND", "PATANJALI", "PEL", "PERSISTENT",
"PETRONET", "PFC", "PIDILITIND", "PIIND",
...
"SHREECEM", "SHRIRAMFIN", "SIEMENS", "SOLARINDS",
"SONACOMS", "SRF", "SUNPHARMA",

"TATACHEM", "TATACOMM", "TATACONSUM",
"TATAMOTORS", "TATAPOWER", "TATASTEEL", "TCS",
"TECHM", "TITAN", "TORNTPHARM", "TORNTPOWER",
"TRENT", "TVSMOTOR",

"ULTRACEMCO", "UNIONBANK",
...
def detect_patterns(data: dict) -> list[dict]:
    ...
    for symbol, df in data.items():
        ...
        try:
            ...
            if score >= 4 and patterns_found and direction:
                signals.append({
                    "symbol": symbol,
                    "direction": direction,
