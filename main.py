...
FNO_SYMBOLS = [
    "ICICIBANK", "HDFCBANK", "INFY", "RELIANCE", "M&M",
"SBIN", "BSE", "ETERNAL", "HINDALCO", "OIL",
"POWERINDIA", "IDEA", "CANBK", "TCS", "MCX",
"ADANIPOWER", "AXISBANK", "VMM", "DIXON", "LT",
"VEDL", "TATASTEEL", "HCLTECH", "PERSISTENT", "BHARTIARTL",
"INDIGO", "OFSS", "ONGC", "SAMMAANCAP", "PFC",
"ADANIGREEN", "ADANIENT", "WIPRO", "MUTHOOTFIN", "ITC",
"POWERGRID", "AMBER", "BAJFINANCE", "GMRAIRPORT", "COFORGE",
"KALYANKJIL", "TORNTPHARM", "BHEL", "COALINDIA", "SUNPHARMA",
"TECHM", "RBLBANK", "WAAREEENER", "SHRIRAMFIN", "ASHOKLEY",
"NATIONALUM", "HINDPETRO", "ADANIENSOL", "EICHERMOT", "SAIL",
"SUZLON", "PATANJALI", "ADANIPORTS", "MARUTI", "JIOFIN",
"PNB", "LTM", "HINDZINC", "TITAN", "TRENT",
"BANDHANBNK", "PGEL", "TATAPOWER", "MAZDOCK", "LAURUSLABS",
"BEL", "BANKBARODA", "TMPV", "CGPOWER", "APOLLOHOSP",
"SONACOMS", "GVT&D", "YESBANK", "BOSCHLTD", "POLICYBZR",
"BHARATFORG", "TIINDIA", "KAYNES", "HAL", "SWIGGY",
"SOLARINDS", "SRF", "INDIANB", "RECLTD", "DMART",
"RVNL", "VBL", "ANGELONE", "INDHOTEL", "UNIONBANK",
"HEROMOTOCO", "LUPIN", "FORCEMOT", "KEI", "NESTLEIND",
"MANAPPURAM", "MPHASIS", "TVSMOTOR", "FEDERALBNK", "ASIANPAINT",
"NTPC", "KOTAKBANK", "TATAELXSI", "IOC", "BPCL",
"INDUSINDBK", "NMDC", "CDSL", "PAYTM", "BANKINDIA",
"IDFCFIRSTB", "INOXWIND", "NBCC", "ABB", "BRITANNIA",
"CHOLAFIN", "MOTHERSON", "COCHINSHIP", "BAJAJ-AUTO", "POLYCAB",
"IRFC", "NUVAMA", "HINDUNILVR", "JINDALSTEL", "BAJAJFINSV",
"DELHIVERY", "LICI", "NHPC", "LODHA", "JSWENERGY",
"HYUNDAI", "CUMMINSIND", "JSWSTEEL", "ULTRACEMCO", "BDL",
"AUBANK", "HDFCAMC", "UPL", "AMBUJACEM", "MAXHEALTH",
"AUROPHARMA", "PREMIERENE", "DIVISLAB", "GAIL", "NYKAA",
"DLF", "DABUR", "INDUSTOWER", "DRREDDY", "GLENMARK",
"SBILIFE", "IREDA", "CIPLA", "HDFCLIFE", "KPITTECH",
"ZYDUSLIFE", "EXIDEIND", "PIDILITIND", "LTF", "FORTIS",
"KFINTECH", "VOLTAS", "PIIND", "360ONE", "SIEMENS",
"NAUKRI", "APLAPOLLO", "GRASIM", "ALKEM", "MARICO",
"ABCAPITAL", "TATACONSUM", "GODFRYPHLP", "GODREJPROP", "COLPAL",
"CAMS", "CROMPTON", "BIOCON", "MOTILALOFS", "UNITDSPR",
"MANKIND", "LICHSGFIN", "ASTRAL", "RADICO", "ICICIGI",
"SHREECEM", "JUBLFOOD", "CONCOR", "NAM-INDIA", "DALBHARAT",
"PNBHOUSING", "ICICIPRULI", "BLUESTARCO", "GODREJCP", "MFSL",
"IEX", "HAVELLS", "PAGEIND", "UNOMINDA", "SBICARD",
"PRESTIGE", "BAJAJHLDNG", "PETRONET", "OBEROIRLTY", "PHOENIXLTD",
"SUPREMEIND"
]
